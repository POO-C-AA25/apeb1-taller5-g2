...
public class Problema1_EjecutorProducto {
    ...
    public static void main(String[] args) {
        ...
        inventario[0] = new Problema1_Producto("PS5 edicion MarioKart", 699.99, 10);
        inventario[1] = new Problema1_Producto("IPhone 16", 799.99, 15);
        inventario[2] = new Problema1_Producto("Laptop Gaming", 1299.99, 8);
        inventario[3] = new Problema1_Producto("Auriculares Gaming", 59.99, 20);
        inventario[4] = new Problema1_Producto("Xbox Series X", 599.99, 10);
